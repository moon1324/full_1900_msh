...
// Date : 날짜 타입으로 선언
// Boolean : 불리언으로 선언
// Mixed : 무엇이돈 가능한 타입으로 선언
// ObjectId : 다른 스키마를 참조할 떄 선언(속성 중, ref와 같이 사용)
// Array : [] 기호를 사용해서 선언, {names: [String]}

// 스키마 생성 시, 추가 속성
// required : boolean, 해당 속성이 필수인지 여부
// default : 기본값 설정
// validate : function, 유효성 겁증 함수 추가, 리턴은 boolean
// immutable : boolean, true로 설정 시 값을 변경할 수 없다.
