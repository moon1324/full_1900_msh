// 제네릭(generic)이란?
// 재사용성 높은 컴포넌트를 만들 때 사용하며, 한가지 타입보다 여러 타입에서 동작하는 컴포넌트를 생성하는데 사용한다.
...
// const genericText3 = <number>(value: number): number => {
//     return value;
// };
// const genericText3 = <T>(value: T): T => {
//     return value;
// };
...
//     // T타입에 뭐가 들어올지 모르는데 string에서만 쓰는 length를 쓸수 없다
...
// console.log(getProductItems("names"));
